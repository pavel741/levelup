...
interface Props {
  ...
  months?: number // Number of months to compare (default: 6)
}

export function FinanceMonthlyComparison({ transactions, months = 6 }: Props) {
  ...
  if (!transactions.length) {
    return (
      <div className="flex items-center justify-center h-64 text-sm text-gray-500 dark:text-gray-400">
        No transaction data yet to show monthly comparison.
      </div>
    )
  }
